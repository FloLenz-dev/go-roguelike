...
/*func (monster *revivableMonster) revive(dungeon Dungeon, minY int, maxY int, minX int, maxX int, hp int){
...
func initGame() (tcell.Screen, Dungeon, Player, []Monster){
    ...
    player := Player{         position: playerPosition,	hp: 25,  dex: 1,  xp:  0}
	...
	basicMonsters := []basicMonster{
		{name: "Rat",         position: ratPosition,  hp: 3,   dex: 1,  xpGain: 1},
